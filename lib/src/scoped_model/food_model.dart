...
class FoodModel extends Model {
  ...
  Future<bool> fetchFood() async {
    ...
    try {
      final http.Response response =
          await http.get("https://fooddelivery-7571a.firebaseio.com/foods.json");
  ...
  Future<bool> updateFood(Map<String, dynamic> foodData, String foodId) async{
    ...
    try{
      await http.put("https://fooddelivery-7571a.firebaseio.com/foods/${foodId}.json", body: json.encode(foodData));
  ...
  Future<bool> deleteFood(String foodId) async{
    ...
    try{
      final http.Response response = await http.delete("https://fooddelivery-7571a.firebaseio.com/foods/${foodId}.json");
